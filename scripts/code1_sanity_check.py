...
# Quick check that code 1 table matches expectation.

# Get expected map of codon to amino acid, for standard code.
...
possible_start_codons = set(['TTG', 'CTG', 'ATG'])

obs_codon_to_aa = {}
obs_possible_start_codons = set()

with open('../genetic_codes/code1.tsv', 'r') as code11:
    code11.readline()
    for line in code11:
        line = line.rstrip()
